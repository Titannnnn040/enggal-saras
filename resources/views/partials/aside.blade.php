    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
          ...
          <li class="nav-item d-flex ms-3 align-items-baseline" style="cursor: pointer;">
            ...
            <div class="sub-menu" style="">
              <div class="d-flex flex-column rounded p-2 ms-3"  style="background-color:#FFFFFF;">
                ...
                <a href="{{route('index.antrian')}}" class="dropdown-menu col-lg-10 d-flex mt-1 {{ ($title === 'antrian') ? 'active' : '' }} text-decoration-none">
                  <div class="text-white text-center ms-1 me-2 d-flex align-items-center justify-content-center">
                    <i class="fa-solid fa-clipboard-user me-2"></i>
                    <span class="nav-link-text ms-2">Antrian Pendaftaran</span>
                  </div>
                </a>
                <a href="/pasien/data-regist-pasien" class="dropdown-menu col-lg-10 d-flex mt-1 {{ ($title === 'data-regist-pasien') ? 'active' : '' }} text-decoration-none">
                  <div class="text-white text-center ms-1 me-2 d-flex align-items-center justify-content-center">
                    <i class="fa-solid fa-clipboard-user me-2"></i>
                    <span class="nav-link-text ms-2">Registrasi Pasien</span>
                  </div>
                </a>
                <a href="{{route('data-registrasi-pasien-luar')}}" class="dropdown-menu col-lg-10 d-flex mt-1 {{ ($title === 'data-regist-pasien-luar') ? 'active' : '' }} text-decoration-none">
                  <div class="text-white text-center ms-1 me-2 d-flex align-items-center justify-content-center">
                    <i class="fa-solid fa-clipboard-user me-2"></i>
                    <span class="nav-link-text ms-2">Registrasi Pasien Luar</span>
                  </div>
                </a>
                <a href="{{route('penjadwalan-dokter')}}" class="dropdown-menu col-lg-10 d-flex mt-1 {{ ($title === 'jadwal-dokter') ? 'active' : '' }} text-decoration-none">
                  <div class="text-white text-center ms-1 me-2 d-flex align-items-center justify-content-center">
                    <i class="fa-solid fa-clipboard-user me-2"></i>
                ...
                <a href="{{route('data-tracer-rekam-medis')}}" class="dropdown-menu col-lg-10 d-flex mt-1 {{ ($title === 'tracer-rekam-medis') ? 'active' : '' }} text-decoration-none">
                  <div class="text-white text-center ms-1 me-2 d-flex align-items-center justify-content-center">
                    <i class="fa-solid fa-clipboard-user me-2"></i>
                    <span class="nav-link-text ms-2">Tracer Rekam Medis</span>
                  </div>
                </a>
              </div>
            </div>
          ...
          <li class="nav-item d-flex ms-3 align-items-baseline" style="cursor: pointer">
            ...
            <div class="sub-lab">
              <div class="d-flex flex-column rounded p-2 ms-3 mt-2"  style="background-color:#FFFFFF;">
                ...
                <a href="{{ route('data-group-pemeriksaan-lab') }}" class="dropdown-menu col-lg-10 d-flex mt-1 {{ ($title === 'data-group-pemeriksaan-lab') ? 'active' : '' }} text-decoration-none">
                  <div class="text-white text-center ms-1 me-2 d-flex align-items-center justify-content-center">
                    <i class="fa-solid fa-clipboard-user me-2"></i>
          ...
          <li class="nav-item d-flex ms-3 align-items-baseline" style="cursor: pointer">
            <div class="sub-menu d-block m-0" style="position:unset">
              <div class="d-flex flex-column">
                <a href="{{route('index.anjungan')}}" class="dropdown-menu col-lg-10 d-flex mt-1 {{ ($title === 'anjungan') ? 'active' : '' }} text-decoration-none">
                  <div class="text-white text-center ms-1 me-2 d-flex align-items-center justify-content-center">
                    <i class="fa-solid fa-clipboard-user me-2"></i>
                    <span class="nav-link-text ms-2">Anjungan</span>
                  </div>
                </a>
              </div>
            </div>
