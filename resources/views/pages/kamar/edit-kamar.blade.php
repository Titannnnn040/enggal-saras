            ...
            <div class="card my-3  border border-0">
              ...
              <div class="card-body px-5 pb-2">
                <div class="form"  style="background-color:#FDFEFD;">
                    <div class="content">
                        <form action="/kamar/update-kamar/{{ $kamar->id }}" method="post" class="d-flex col-lg-12"> 
                            @csrf    
                            @method('put') 
                                    ...
                                    <div class="col-lg-12 col-xl-12 col-xxl-12 me-0 row">
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                    <input type="text" class="form-control @error('nama_kamar') is-invalid @enderror" id="nama_kamar" name="nama_kamar" value="{{ old('nama_kamar') }}{{ $kamar->nama_kamar }}">
                                                    @error('nama_kamar')
                                                ...
                                                <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                    <div class="">
                                                        <select class="form-select @error('jenis_kamar') is-invalid @enderror" name="jenis_kamar"  id="jenis_kamar">
                                                            ...
                                                            <option value="Rawat Inap" {{ $kamar->jenis_kamar == 'Rawat Inap' ? 'selected' : '' }}>Rawat Inap</option>
                                                        </select>          
                                                        @error('jenis_kamar')
                                                        <div class="invalid-feedback d-block">
                                                            {{ $message }}
                                                    ...
                                                    <div class="d-flex form-check form-switch mt-3">
                                                        <input type="checkbox" class="form-check-input @error('status') is-invalid @enderror" id="status" name="status" value="aktif" {{ $kamar->status == 'aktif' ? 'checked' : '' }}>
