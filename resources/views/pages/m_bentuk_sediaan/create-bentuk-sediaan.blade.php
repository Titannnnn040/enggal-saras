            ...
            <div class="card my-3  border border-0">
              <div class="card-header p-0 position-relative border border-0 mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3">
                  <h6 class="text-white text-capitalize ps-3">Create Bentuk Sediaan Obat</h6>
                </div>
              </div>
                                ...
                                <div class="d-flex col-lg-12 mb-4">
                                    <div class="col-lg-12 col-xl-12 col-xxl-12 me-0 row">
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                            <div class="d-flex">
                                                <label for="code" class="form-label col-lg-4 me-2">Kode Bentuk Sediaan Obat :</label>
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                            <div class="d-flex">
                                                <label for="bentuk_sediaan_name" class="form-label col-lg-4 me-2">Nama Bentuk Sediaan Obat :</label>
                                                <div class="d-flex flex-column col-lg-8">
                                                    <input type="text" class="form-control @error('bentuk_sediaan_name') is-invalid @enderror" id="bentuk_sediaan_name" name="bentuk_sediaan_name" value="{{ old('bentuk_sediaan_name') }}">
