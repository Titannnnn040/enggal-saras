                ...
                <form action="" class="d-flex col-lg-12">
                  <div class="row col-lg-12">
                    <div class="search col-lg-6">
                      <h6>Kode Tarif Radiologi</h6>
                      <input type="text" name="tarif_radiologi_code">
                    </div>
                   
                    <div class="search col-lg-6">
                      <h6>Nama Tarif Radiologi</h6>
                      <input type="text" name="nama_tarif_radiologi">
                    </div>
                    <div class="submit-filter d-flex  justify-content-between mt-3">
                      ...
                      <a href="/tarif/data-tarif-radiologi" class="btn btn-danger col-lg-1">clear</a>
                    </div>
                  </div>
                </form>
              </div>
