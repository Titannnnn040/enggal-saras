                ...
                <form action="" class="d-flex col-lg-12">
                  <div class="row col-lg-12">
                    <div class="search col-lg-6">
                      <h6>Kode Tarif Pendaftaran</h6>
                      <input type="text" name="code_pendaftaran">
                    </div>
                   
                    <div class="search col-lg-6">
                      <h6>Nama Tarif Pendaftaran</h6>
                      <input type="text" name="nama_pendaftaran">
                    </div>
                    <div class="submit-filter d-flex  justify-content-between mt-3">
                      ...
                      <a href="/tarif/data-tarif-pendaftaran" class="btn btn-danger col-lg-1">clear</a>
                    </div>
                  </div>
                </form>
              </div>
          ...
          <div class="card my-3">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-success shadow-success d-flex align-items-center justify-content-between border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3 mb-0  d-flex align-items-center" style="margin-top:-9px;">Data Tarif Pendaftaran</h6>
                <a href="/tarif/create-tarif-pendaftaran" class="my-0 me-3 btn-add-data d-flex align-items-center">
                  ...
                  <table class="table align-items-center mb-0" id="myTables">
                      <thead>
                          <tr>
                            ...
                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Kode Tarif Pendaftaran</th>
                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nama Tarif Pendaftaran</th>
                      ...
                      @foreach ($pendaftaran as $item)
                        <tbody>
                            <tr>
                                ...
                                <td class="align-middle text-center text-xs">
                                    <p class="text-xs font-weight-bold mb-0 text-center">{{ $item->code_pendaftaran }}</p>
                                </td>
                                <td class="align-middle text-center text-xs">
                                    <p class="text-xs font-weight-bold mb-0 text-center">{{ $item->nama_pendaftaran }}</p>
                                </td>
                                <td class="align-middle text-center text-xs">
                                ...
                                <td class="align-middle text-center">
                                    <span class="text-secondary text-xs font-weight-bolder d-flex justify-content-center align-center">
                                      <form action="/tarif/edit-tarif-pendaftaran/{{ $item->id }}">
                                        @csrf
                                      ...
                                      <form action="/tarif/delete-tarif-pendaftaran/{{ $item->id }}" method="post">
                                        @method('delete')
                                        @csrf
