            ...
            <div class="card my-3  border border-0">
              ...
              <div class="card-body px-5 pb-2">
                <div class="form"  style="background-color:#FDFEFD;">
                    <div class="content">
                        <form action="/tarif/update-tarif-lab/{{ $tarifLab->id}}" method="post" class="d-flex col-lg-12"> 
                            @csrf    
                            @method('put')
                                ...
                                <div class="d-flex col-lg-12 mb-4">
                                    <div class="col-lg-12 col-xl-12 col-xxl-12 me-0 row">
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                            <div class="d-flex">
                                                <label for="code" class="form-label col-lg-3 col-xl-3 col-xxl-2 me-2">Kode Tarif Laboratorium :</label>
                                                <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                    <input type="text" class="form-control "  id="code_tarif_lab" name="code_tarif_lab"  value="{{ $tarifLab->code_tarif_lab }}" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                    <input type="text" class="form-control "  id="nama_tarif_lab" name="nama_tarif_lab"  value="{{ $tarifLab->nama_tarif_lab }}">
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                    <select class="form-select @error('group_tarif_id') is-invalid @enderror" name="group_tarif_id"  id="group_tarif_id">
                                                        ...
                                                        @foreach ($groupTarif as $item)
                                                            <option value="{{ $item->id }}" {{ $item->id == $tarifLab->group_tarif_id ? 'selected' : '' }}>{{ $item->nama_group_tarif }}</option>
                                                        @endforeach
                                                    </select>          
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                    <input type="text" class="form-control @error('fee_medis') is-invalid @enderror"  oninput="calculateTotal()" id="fee_medis" name="fee_medis" value="{{ number_format($tarifLab->fee_medis) }}">
                                                    @error('fee_medis')
                                                    <div class="invalid-feedback d-block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                    <input type="text" class="form-control @error('jasa_klinik') is-invalid @enderror" id="jasa_klinik"  oninput="calculateTotal()"  name="jasa_klinik" value="{{ number_format($tarifLab->jasa_klinik) }}">
                                                    @error('jasa_klinik')
                                                    <div class="invalid-feedback d-block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                    <input type="text" class="form-control @error('jasa_pengirim') is-invalid @enderror" id="jasa_pengirim"  oninput="calculateTotal()"  name="jasa_pengirim" value="{{ number_format($tarifLab->jasa_pengirim) }}">
                                                    @error('jasa_pengirim')
                                                    <div class="invalid-feedback d-block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                    <input type="text" class="form-control @error('biaya_rujukan') is-invalid @enderror" id="biaya_rujukan"  oninput="calculateTotal()"  name="biaya_rujukan" value="{{ number_format($tarifLab->biaya_rujukan) }}">
                                                    @error('biaya_rujukan')
                                                    <div class="invalid-feedback d-block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                    <input type="text" class="form-control " disabled id="total_tarif" name="total-tarif"  value="{{ number_format($tarifLab->total_tarif) }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <script>
                                            ...
                                            function calculateTotal() {
                                                ...
                                                let totalFee = roomPrice + serviceFee + pengirimFee + rujukanFee;
