                ...
                <form action="" class="d-flex col-lg-12">
                  <div class="row col-lg-12">
                    <div class="search col-lg-6">
                      <h6>Kode Tarif Laboratorium</h6>
                      <input type="text" name="code_tarif_lab">
                    </div>
                   
                    <div class="search col-lg-6">
                      <h6>Nama Tarif Laboratorium</h6>
                      <input type="text" name="nama_tarif_lab">
                    </div>
                    <div class="submit-filter d-flex  justify-content-between mt-3">
                      ...
                      <a href="/tarif/data-tarif-lab" class="btn btn-danger col-lg-1">clear</a>
                    </div>
                  </div>
                </form>
              </div>
