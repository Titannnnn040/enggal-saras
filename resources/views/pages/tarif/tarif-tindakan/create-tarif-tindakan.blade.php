                                    ...
                                    <div class="col-lg-12 col-xl-12 col-xxl-12 me-0 row">
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                    <input type="text" class="form-control " style="text-transform: uppercase;" id="nama_tarif_tindakan" name="nama_tarif_tindakan"  value="">
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                    <select class="form-select @error('group_tarif_id') is-invalid @enderror" name="group_tarif_id"  id="group_tarif_id">
                                                        ...
                                                        @foreach ($groupTarifTindakan as $item)
                                                            <option value="{{ $item->id }}">{{ $item->nama_group_tarif_tindakan }}</option>
                                                        @endforeach
                                                    </select>          
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                    <input type="text" class="form-control @error('jasa_lainya') is-invalid @enderror" id="jasa_lainya"  oninput="calculateTotal()"  name="jasa_lainya" value="">
                                                    @error('jasa_lainya')
                                                    <div class="invalid-feedback d-block">
                                                        {{ $message }}
                                                    </div>
