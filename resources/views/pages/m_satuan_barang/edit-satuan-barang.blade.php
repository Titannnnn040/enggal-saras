            ...
            <div class="card my-3  border border-0">
              <div class="card-header p-0 position-relative border border-0 mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3">
                  <h6 class="text-white text-capitalize ps-3">Edit Satuan Barang</h6>
                </div>
              </div>
              <div class="card-body px-5 pb-2">
                <div class="form"  style="background-color:#FDFEFD;">
                    <div class="content">
                        <form action="{{route('update-satuan-barang', ['code' => $satuanBarang->satuan_barang_code])}}" method="post" class="d-flex col-lg-12"> 
                            @csrf    
                            @method('put') 
                                    ...
                                    <div class="col-lg-12 col-xl-12 col-xxl-12 me-0 row">
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                    <input type="text" class="form-control " disabled id="kode-kamar" name="kode-kamar"  value="{{ $satuanBarang->satuan_barang_code }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                    <input type="text" style="text-transform: uppercase" class="form-control @error('satuan_barang_name') is-invalid @enderror" id="satuan_barang_name" name="satuan_barang_name" value="{{ $satuanBarang->satuan_barang_name }}">
