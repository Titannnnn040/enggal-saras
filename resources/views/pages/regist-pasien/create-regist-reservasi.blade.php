...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg overflow-x-hidden" >
    <div class="container-fluid py-1">
        ...
        <div class="row">
            <div class="mt-4"> 
                <form action="{{route('store-regist-pasien', ['id' => $reservasi->id])}}" method="post">
                    @csrf
                                            ...
                                            <div class="col-lg-12 col-xl-12 col-xxl-12 me-0 row">
                                                        ...
                                                        <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                            <select class="form-select @error('jaminan') is-invalid @enderror" name="jaminan" id="jaminan">
                                                                ...
                                                                @foreach ($jaminan as $item)
                                                                    <option value="{{ $item->nama_jaminan }}">{{ $item->nama_jaminan }}</option>
                                                                @endforeach
                                                            </select>
                                                            @error('jaminan')
                                                            <div class="invalid-feedback d-block">
                                                ...
                                                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                            <select class="form-select @error('dokter') is-invalid @enderror" name="dokter" id="dokterSelect">
                                                            </select>
                                                            @error('dokter')
                                                            <div class="invalid-feedback d-block">
                                                                {{ $message }}
                                            ...
                                            <div class="col-lg-12 col-xl-12 col-xxl-12 me-0 row">
                                                ...
                                                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                            <select class="form-select" name="jam_praktek">
