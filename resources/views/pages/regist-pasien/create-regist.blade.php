                                                    ...
                                                    <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                                        <div class="d-flex gap-1">
                                                            <div class="col-lg-6 d-flex">
                                                                ...
                                                                <div class="d-flex col-lg-5">
                                                                    <input type="text" class="form-control  @error('tinggi_badan') is-invalid @enderror" style="border-radius:5px 0 0 5px;" id="tinggi_badan" name="tinggi_badan" value="{{ old('tinggi_badan') }}">
                                                            ...
                                                            <div class="col-lg-6 d-flex">
                                                                ...
                                                                <div class="d-flex col-lg-5">
                                                                    <input type="text" class="form-control  @error('berat_badan') is-invalid @enderror" style="border-radius:5px 0 0 5px;" id="berat_badan" name="berat_badan" value="{{ old('berat_badan') }}">
