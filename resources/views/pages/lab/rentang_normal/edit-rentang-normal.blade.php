            ...
            <div class="card my-3  border border-0">
              <div class="card-header p-0 position-relative border border-0 mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3">
                  <h6 class="text-white text-capitalize ps-3">Edit Rentang Normal</h6>
                </div>
              </div>
              <div class="card-body px-5 pb-2">
                <div class="form"  style="background-color:#FDFEFD;">
                    <div class="content">
                        <form action="{{route('update-rentang-normal', ['code' => $data->code])}}" method="post" class="d-flex col-lg-12"> 
                            @csrf     
                            @method('put')
                                    ...
                                    <div class="col-lg-12 col-xl-12 col-xxl-12 me-0 row">
                                        <div class="col-md-9 col-lg-9 col-xl-9 col-xxl-9 mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                                    <input type="text" class="form-control" id="code" code="code" value="{{ $data->code }}" readonly>
                                                    @error('code')
                                                ...
                                                <div class="d-flex flex-column col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                                    <select class="form-select @error('satuan_umur') is-invalid @enderror" name="satuan_umur"  id="satuan_umur">
                                                        ...
                                                        @foreach ($rentangUmur as $item)
                                                            <option value="{{$item->waktu}}" {{$item->waktu == $data->satuan_umur ? 'selected' : ''}}>{{$item->waktu}}</option>
                                                        @endforeach
                                                    </select>          
                                                    @error('satuan_umur')
                                                    <div class="invalid-feedback d-block">
                                        ...
                                        <div class="col-md-9 col-lg-9 col-xl-9 col-xxl-9 mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex col-lg-12">
                                                    <input type="number" class="form-control @error('batas_bawah') is-invalid @enderror" id="batas_bawah" name="batas_bawah" value="{{ $data->batas_bawah }}">
                                                    <input type="number" class="ms-3 form-control @error('batas_bawah_hari') is-invalid @enderror" id="batas_bawah_hari" name="batas_bawah_hari" value="{{ $data->batas_bawah_hari }}" readonly>
                                        ...
                                        <div class="col-md-9 col-lg-9 col-xl-9 col-xxl-9 mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex col-lg-12">
                                                    <input type="number" class="form-control @error('batas_atas') is-invalid @enderror" id="batas_atas" name="batas_atas" value="{{ $data->batas_atas }}">
                                                    <input type="number" class="ms-3 form-control @error('batas_atas_hari') is-invalid @enderror" id="batas_atas_hari" name="batas_atas_hari" value="{{ $data->batas_atas_hari }}" readonly>
                                                    <label for="bawah_hari" class="form-label m-2">Hari</label>
                                                </div>
                                                @error('batas_atas')
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                                    <select class="form-select @error('gender') is-invalid @enderror" name="gender"  id="gender">
                                                        ...
                                                        <option value="SEMUA"  {{$data->gender == 'SEMUA' ? 'selected' : ''}}>SEMUA</option>
                                                    </select>          
                                                    @error('gender')
                                                    <div class="invalid-feedback d-block">
                                                        {{ $message }}
