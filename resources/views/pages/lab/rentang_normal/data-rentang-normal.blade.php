                ...
                <form action="" class="d-flex col-lg-12">
                  <div class="row col-lg-12">
                    <div class="search col-lg-6">
                      <h6>Kode Rentang Normal</h6>
                      <input type="text" name="code">
                    </div>
                    <div class="search col-lg-6">
                      <h6>Nama Rentang Normal</h6>
                    ...
                    <div class="submit-filter d-flex  justify-content-between mt-3">
                      ...
                      <a href="{{route('data-rentang-normal')}}" class="btn btn-danger col-lg-1">clear</a>
                    </div>
                  </div>
                </form>
              </div>
          ...
          <div class="card my-3">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-success shadow-success d-flex align-items-center justify-content-between border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3 mb-0  d-flex align-items-center" style="margin-top:-9px;">Data Rentang Normal</h6>
                <a href="{{route('create-rentang-normal')}}" class="my-0 me-3 btn-add-data d-flex align-items-center">
                  ...
                  <table class="table align-items-center mb-0" id="myTables">
                      <thead>
                          <tr>
                            ...
                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Kode Rentang Normal</th>
                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nama Rentang Normal</th>
                            ...
                            <tr>
                              ...
                              <td class="align-middle text-center">
                                  <span class="text-secondary text-xs font-weight-bolder d-flex justify-content-center align-center">
                                    <form action="{{route('edit-rentang-normal', ['code' => $item->code])}}">
                                      @csrf
                                    ...
                                    <form action="{{ route('delete-rentang-normal', ['code' => $item->code]) }}" id="delete-form-{{$item->id}}" data-id="{{$item->id}}" method="post">
                                      @method('delete')
                                      @csrf
