                                    ...
                                    <div class="col-lg-12 col-xl-12 col-xxl-12 me-0 row">
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="change-form-lab" id="button-open-kuantitatif" value="1" required>
                                                <label class="form-check-label" for="button-open-kuantitatif">
                                                    Kuantitatif
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="change-form-lab" id="button-open-kualitatif"  value="2" required>
                                                <label class="form-check-label" for="button-open-kualitatif">
                                                    Kualitatif
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="change-form-lab" id="button-open-kualitatif-khusus"  value="3" required>
