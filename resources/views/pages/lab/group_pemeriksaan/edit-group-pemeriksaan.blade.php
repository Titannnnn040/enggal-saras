                            ...
                            <div class="content">
                                <form action="" method="post" class="d-flex col-lg-12"> 
                                            ...
                                            <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="d-flex flex-column col-lg-5 col-xl-5 col-xxl-5">
                                                        <input type="text" class="form-control" id="kelompok" name="kelompok" disabled value="{{$data->name}}">
                                                    </div>
                                                </div>
                                    ...
                                    <template id="selectTemplate">
                                        <div class="d-flex align-items-center mb-2 px-4 col-lg-5" style="background-color:rgb(243, 243, 243);border:solid rgba(0, 0, 0, 0.123) 1px;border-radius:5px" id="card-drag" draggable="true">
                                            <style>
                                                select {
                                                    font-family: monospace; /* Gunakan font monospace agar karakter memiliki lebar yang sama */
                                                    white-space: pre; /* Pertahankan spasi tambahan */
                                                }
                                            </style>
                                            <select class="form-select select2">
                                                ...
                                                @foreach ($pemeriksaan as $item)
                                                    <option value="{{$item->code}}">
                                                        {{ $item->name }} | {{ $item->code }} | {{ $item->jenis }} | {{ $item->keterangan }}
                                                    </option>
                                                @endforeach
                                            </select>
