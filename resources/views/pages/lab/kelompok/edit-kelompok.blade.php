            ...
            <div class="mt-4"> 
                <div class="card my-3  border border-0">
                    <div class="card-header p-0 position-relative border border-0 mt-n4 mx-3 z-index-2">
                        ...
                        <h6 class="text-white text-capitalize ps-3">Edit Kelompok</h6>
                        </div>
                    </div>
                    <div class="card-body px-5 pb-2">
                        <div class="form"  style="background-color:#FDFEFD;">
                            <div class="content">
                                <form action="/kelompok-lab/update-kelompok-lab/{{ $data->code }}" method="post" class="d-flex col-lg-12"> 
                                    @csrf    
                                    @method('put') 
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="d-flex col-lg-12 mb-4">
                                            <div class="col-lg-12 col-xl-12 col-xxl-12 me-0 row">
                                                ...
                                                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                                    <div class="d-flex">
                                                        <label for="code" class="form-label col-lg-2 col-xl-3 col-xxl-2 me-2">Kode Kelompok :</label>
                                                        <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                            <input type="text" class="form-control " disabled id="code" name="code"  value="{{ $data->code }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                                    <div class="d-flex">
                                                        <label for="kelompok" class="form-label col-lg-2 col-xl-3 col-xxl-2 me-2">Nama Kelompok :</label>
                                                        <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                            <input type="text" class="form-control @error('kelompok') is-invalid @enderror" id="kelompok" name="kelompok" value="{{ old('kelompok') }}{{ $data->kelompok }}">
                                                            @error('kelompok')
                                        ...
                                        <div class="col-lg-12">
                                            <a href="{{route('data-kelompok-lab')}}" class="btn btn-danger col-lg-2 ms-1">Cancel</a>
