            ...
            <div class="card my-3  border border-0">
              <div class="card-header p-0 position-relative border border-0 mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3">
                  <h6 class="text-white text-capitalize ps-3">Create Jaminan</h6>
                </div>
              </div>
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                    <input type="text" class="form-control @error('nama_jaminan') is-invalid @enderror" id="nama_jaminan" name="nama_jaminan" value="{{ old('nama_jaminan') }}" style="text-transform: uppercase;">
                                                    @error('nama_jaminan')
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                    <select class="form-select @error('tipe_jaminan') is-invalid @enderror" name="tipe_jaminan"  id="tipe_jaminan">
                                                        ...
                                                        <option value="PRIBADI/UMUM">PRIBADI/UMUM</option>
                                                    </select>          
                                                    @error('tipe_jaminan')
                                                    <div class="invalid-feedback d-block">
                                                        {{ $message }}
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex form-check form-switch">
                                                    <input type="checkbox" class="form-check-input @error('detail_harga') is-invalid @enderror" id="detail_harga" name="detail_harga" value="Yes">
