                                    ...
                                    <div class="col-lg-12 col-xl-12 col-xxl-12 me-0 row">
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                    <input type="text" class="form-control @error('nama_tipe_jaminan') is-invalid @enderror" id="nama_tipe_jaminan" name="nama_tipe_jaminan" value="{{ $tipeJaminan->nama_tipe_jaminan }}"  style="text-transform: uppercase;">
