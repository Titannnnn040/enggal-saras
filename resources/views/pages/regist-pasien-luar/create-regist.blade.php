                                                        ...
                                                        <div class="d-flex flex-column col-md-10">
                                                            <div class="d-flex">
                                                                <div class="col-md-7 col-lg-9">
                                                                    <input type="date_now" class="form-control @error('date_now') is-invalid @enderror" id="date_now" name="date_now" value="{{date('Y-m-d')}}" readonly>      
                                                                </div>
                                                                <div class="col-lg-3 ms-3">
                                                                    <input type="" class="form-control @error('time_now') is-invalid @enderror" id="" name="" value="{{date('H:i')}}" readonly>      
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-lg-12 me-0 row">
                                                ...
                                                <div class="col-md-12 col-lg-12 mb-3">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="d-flex flex-column col-md-10">
                                                            <input type="text" name="address" class="form-control bg-gray-300 @error('address') is-invalid @enderror" id="address" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-12 col-lg-12 mb-3">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="d-flex flex-column col-md-10">
                                                            <input type="date" name="dob" id="dob" class="@error('dob') is-invalid @enderror form-control bg-gray-300" readonly>
                                                            @error('dob')
                                                            <div class="invalid-feedback d-block">
                                                                {{ $message }}
                                                            </div>
