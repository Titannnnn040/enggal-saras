                                    ...
                                    <div class="col-lg-12 col-xl-12 col-xxl-12 me-0 row">
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                    <input type="text" class="form-control @error('kode_layanan_bpjs') is-invalid @enderror" id="kode_layanan_bpjs" name="kode_layanan_bpjs" value="{{ old('kode_layanan_bpjs') }}">
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                        <input type="text" class="form-control @error('id_satu_sehat') is-invalid @enderror" id="id_satu_sehat" name="id_satu_sehat" value="{{ old('id_satu_sehat') }}" disabled>
                                                    </div>
