            ...
            <div class="card my-3  border border-0">
              ...
              <div class="card-body px-5 pb-2">
                <div class="form"  style="background-color:#FDFEFD;">
                    <div class="content">
                        <form action="{{route('update-template-lab', ['uuid' => $data->uuid])}}" method="post" class="d-flex col-lg-12"> 
                            @method('PUT')
                            @csrf     
                                    ...
                                    <div class="col-lg-12 col-xl-12 col-xxl-12 me-0 row">
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                    <textarea class="form-control @error('content') is-invalid @enderror" id="content" name="content">{{ $data->content }}</textarea>
                                                    @error('content')
                                                    <div class="invalid-feedback d-block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-colum">
                                                    <input type="checkbox" class="form-checkbox @error('default') is-invalid @enderror" id="default" name="default" {{$data->default == 1 ? 'checked' : ''}} value="1">
                                                    @error('default')
                                                    <div class="invalid-feedback d-block">
                                                        {{ $message }}
                                                    </div>
