                ...
                <form action="" class="d-flex col-lg-12">
                  <div class="row col-lg-12">
                    ...
                    <div class="submit-filter d-flex  justify-content-between mt-3">
                      ...
                      <a href="{{route('data-group-pemeriksaan-lab')}}" class="btn btn-danger col-lg-1">clear</a>
                    </div>
                  </div>
                </form>
              </div>
          ...
          <div class="card my-3">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-success shadow-success d-flex align-items-center justify-content-between border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3 mb-0  d-flex align-items-center" style="margin-top:-9px;">Data Group</h6>
              </div>
            </div>
            <div class="card-body px-5 pb-2">
                  ...
                  <table class="table align-items-center mb-0" id="myTables">
                      <thead>
                          <tr>
                            ...
                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Pemeriksaan</th>
                      ...
                      <tbody>
                        ...
                        {{-- <tr>
                          ...
                          <td class="align-middle text-center text-xs">
                              <p class="text-xs font-weight-bold mb-0 text-center">TESTER-01</p>
                          </td>
                          <td class="align-middle text-center text-xs">
                              <p class="text-xs font-weight-bold mb-0 text-center">KELOMPOK</p>
                          </td>
                          <td class="align-middle text-center text-xs">
                              <p class="text-xs font-weight-bold mb-0 text-center">KETERANGAN</p>
                          </td>
                          <td class="align-middle text-center">
                              <span class="text-secondary text-xs font-weight-bolder d-flex justify-content-center align-center">
                                <form action="{{ route('edit-group-pemeriksaan-lab')}}">
                                  @csrf
                                  <button class="btn btn-outline-success" id="button-create-user" style="margin-top:10px;margin-bottom:10px;margin-right:10px;"><i class="fa-solid fa-user-pen"></i></button>
                                </form>
                              </span>
                      ...
                      {{-- @foreach ($data as $item)
                        <tbody>
                            <tr>
                                ...
                                <td class="align-middle text-center text-xs">
                                    <p class="text-xs font-weight-bold mb-0 text-center">{{ $item->group }}</p>
                                </td>
                                <td class="align-middle text-center">
                                    <span class="text-secondary text-xs font-weight-bolder d-flex justify-content-center align-center">
                                      <form action="{{ route('edit-group-lab', ['code' => $item->code]) }}">
                                        @csrf
                                        <button class="btn btn-outline-success" id="button-create-user" style="margin-top:10px;margin-bottom:10px;margin-right:10px;"><i class="fa-solid fa-user-pen"></i></button>
                                      </form>
                                      
                                      <form action="{{ route('delete-group-lab', ['code' => $item->code]) }}" id="delete-form-{{$item->id}}" data-id="{{$item->id}}" method="post">
                                        @method('delete')
                                        @csrf
