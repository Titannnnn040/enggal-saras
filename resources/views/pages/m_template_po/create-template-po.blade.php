                                    ...
                                    <div class="me-0 row">
                                        ...
                                        <div class="mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column col-md-10">
                                                    <input type="text" class="form-control @error('template_po_name') is-invalid @enderror" id="template_po_name" name="template_po_name" value="{{ old('template_po_name') }}">
                                        ...
                                        <div class="mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column col-md-10">
                                                    <textarea name="desc" id="desc" class="form-control @error('desc') is-invalid @enderror" id="" cols="30" rows="4">{{ old('desc') }}</textarea>
                                                    @error('desc')
                                                    <div class="invalid-feedback d-block">
                                                        {{ $message }}
                                                    </div>
