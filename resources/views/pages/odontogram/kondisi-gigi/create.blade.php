                                            ...
                                            <div class="me-0 row">
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="d-flex flex-column col-md-9">
                                                            <select class="form-select @error('jenis') is-invalid @enderror" name="jenis"  id="jenis">
                                                                ...
                                                                <option value="KEADAAN GIGI">KEADAAN GIGI</option>
                                                                <option value="BAHAN RESTORASI">BAHAN RESTORASI</option>
                                                                <option value="RESTORASI">RESTORASI</option>
                                                                <option value="PROTESA">PROTESA</option>
                                                            </select>          
                                                            @error('jenis')
                                                ...
                                                <div class="col-lg-12 mb-3">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="d-flex flex-column col-md-9">
                                                            <input type="text" class="form-control @error('code') is-invalid @enderror" id="code" name="code" value="{{ old('code') }}" placeholder="Kode Penyakit">
                                                            @error('code')
                                                            <div class="invalid-feedback d-block">
                                                                {{ $message }}
                                                            </div>
                                                ...
                                                <div class="col-lg-12 mb-3">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="d-flex flex-column col-md-9">
                                                            <input type="text" class="form-control @error('arti') is-invalid @enderror" id="arti" name="arti" value="{{ old('arti') }}" placeholder="Jenis Penyakit">
                                                            @error('arti')
                                                            <div class="invalid-feedback d-block">
                                                                {{ $message }}
                                                            </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="d-flex flex-column col-md-9">
                                                                <textarea name="keterangan" id="keterangan" class="form-control @error('keterangan') is-invalid @enderror" id="" cols="30" rows="4" placeholder="Keterangan">{{ old('keterangan') }}</textarea>
                                                                @error('keterangan')
                                                                <div class="invalid-feedback d-block">
                                                                    {{ $message }}
                                                                </div>
                                                ...
                                                <div class="col-lg-12 mb-3">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="d-flex flex-column col-md-9">
                                                            <input type="color" class="form-control @error('warna') is-invalid @enderror" id="warna" name="warna" value="{{ old('warna') }}">
                                                            @error('warna')
                                                            <div class="invalid-feedback d-block">
                                                                {{ $message }}
                                                            </div>
