                                    ...
                                    <div class="col-lg-12 col-xl-12 col-xxl-12 me-0 row">
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                    <input type="text" class="form-control @error('pasien_name') is-invalid @enderror" id="pasien_name" name="pasien_name" value="{{ old('pasien_name') }}" disabled>
                                                    @error('pasien_name')
                                                    <div class="invalid-feedback d-block">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-xxl-6 mb-3">
                                            <div class="d-flex">
                                                <label for="alamat" class="form-label col-lg-2 col-xl-3 col-xxl-2 me-2">Alamat :</label>
                                                <div class="d-flex flex-column  col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                    <input type="text" class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat" value="{{ old('alamat') }}" disabled>
                                                    @error('alamat')
                                                        <div class="invalid-feedback d-block">
                                                            {{ $message }}
                                                        </div>
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-xxl-6 mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column  col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                    <input type="text" class="form-control @error('phone_no') is-invalid @enderror" id="phone_no" name="phone_no" value="{{ old('phone_no') }}" disabled>
                                                    @error('phone_no')
                                                        <div class="invalid-feedback d-block">
                                                            {{ $message }}
                                                        </div>
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                    <input type="text" class="form-control @error('gender') is-invalid @enderror" id="gender" name="gender" value="{{ old('gender') }}" disabled>   
                                                    @error('gender')
                                                    <div class="invalid-feedback d-block">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="col-lg-12 col-xl-12 col-xxl-12 me-0 row">
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                            <div class="d-flex">
                                                ...
                                                <div class="d-flex flex-column col-md-7 col-lg-9 col-xl-8 col-xxl-9">
                                                    <select id="dokterSelect" class="form-select @error('dokter') is-invalid @enderror" name="dokter">
                                                        <option value="">Please Select</option>
                                                    </select>          
                                                    @error('dokter')
                                                    <div class="invalid-feedback d-block">
