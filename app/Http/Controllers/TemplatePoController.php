...
class TemplatePoController extends Controller
{
    ...
    public function indexDataTemplatePo(){
        ...
        return view('pages.template_po.data-template-po', ['title' => 'data-template-po', 'data' => $data->get()]);
    }
    public function indexCreateTemplatePo()
    {
        return view('pages.template_po.create-template-po', ['title' => 'create-template-po']);
    }
    ...
    public function edit($code)
    {
        ...
        return view('pages.template_po.edit-template-po', ['title' => 'template-po', 'data' => $data]);
    }
